...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/helpers/compiler.js</span></h1>
    <h2>
        Statements: <span class="metric">82.14% <small>(46 / 56)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">70.59% <small>(24 / 34)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">88.89% <small>(8 / 9)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">83.33% <small>(45 / 54)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">src/helpers/</a> &#187; compiler.js</div>
</div>
<div class="body">
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if(options.template &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >/\.html$/.test(options.template))</span> {
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (templateUrl) {
      resolve.$template = fetchTemplate(templateUrl);
    } else {
<span class="cstat-no" title="statement not covered" >      resolve.$template = $q.when(template);</span>
    }
&nbsp;
